...
export const CardData = [
  ...
  {
    id: 2,
    icon: <GiFishingBoat sx={{ fontSize: 30 ,alignItems:'center'}} />,
    heading: "Departure Approval",
    text: "Karadiya Mobile provide facility for get Departure Approval quickly ",
  },
  {
    id: 3,
    icon: <TiWeatherPartlySunny sx={{ fontSize: 30 ,alignItems:'center'}} />,
  ...
  {
    id: 4,
    icon: <BsCompass sx={{ fontSize: 30 ,alignItems:'center'}} />,
    heading: "Compass",
    text: "Within the Compass feature fishermen can see the  direction in th sea",
  },
  {
    id: 5,
    icon: <BsFillPinMapFill sx={{ fontSize: 30 ,alignItems:'center'}} />,
